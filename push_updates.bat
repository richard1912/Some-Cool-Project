...
:: Some-Cool-Project Update Pusher Script (Windows Version)
:: This script helps push updates to the develop branch of the Some-Cool-Project repository

:: Main script starts here
echo Starting Some-Cool-Project Update Process...
echo.

:: Check if we're in a git repository
if not exist ".git" (
    echo [ERROR] Not in a git repository. Please run this script from the Some-Cool-Project project directory.
    pause
    exit /b 1
)
...
git remote set-url origin https://github.com/richard1912/Some-Cool-Project.git
if errorlevel 1 (
...
echo [INFO] Repository: https://github.com/richard1912/Some-Cool-Project.git
